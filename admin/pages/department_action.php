...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    switch($_POST['action']) {
        ...
        case 'add':
            ...
            $sql .= "values(null,'{$data['department_code']}','{$data['department_text']}','{$data['company_code']}',";
            $sql .= "{$data['active']},";
        ...
        case 'edit':
            $sql ="";
            $sql .= "update tb_department set department_code = '{$data['department_code']}',department_text = '{$data['department_text']}',
