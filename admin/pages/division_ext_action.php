...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    switch($_POST['action']) {
        case 'retrieve':
            $sql = "";
            $sql .= "select * from v_company_department_division_text where 1 = 1 ";
        ...
        case 'add':
            ...
            $sql ="";
            $sql .= "insert into tb_division (division_code,
                                             division_text,
                                             department_code,
                                             company_code,
                                             active,
        ...
        case 'edit':
            ...
            $sql ="";
            $sql .= "update tb_division set division_code = '{$data['division_code']}',
                                           division_text = '{$data['division_text']}',
