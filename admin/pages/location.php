  ...
  $(document).ready(function(){
     ...
     /*---Button Action---*/
      //->New
        ...
        var _location_code = $('#new_location_code').val();
        var _location_text = $('#new_location_text').val();
    ...
                }
       ...
       //->edit
		$('#btn_edit').click(function(){
			...
			$('#edit_location_code').val(getSelectedRowFieldValue('#tab_01','location_code'));
			$('#edit_location_text').val(getSelectedRowFieldValue('#tab_01','location_text'));
        ...
        var _id = $('#edit_id').val();
        var _location_code = $('#edit_location_code').val();
        var _location_text = $('#edit_location_text').val();
...
//         });
    ...
               $.ajax({
    	...
    	               }
    				   ...
    				   window.location='location.php' + _condition;
    	           	 },
						error:function(data){
...
$_location_code = isset($_GET['new_location_code']) ? $_GET['new_location_code'] : "";
$_location_text = isset($_GET['new_location_text']) ? $_GET['new_location_text'] : "";
...
$_body .= " <label for='new_location_code' class='control-label mr-1'>代码</label>";
$_body .= " <input type='text' class='form-control' style='width:120px' id='new_location_code' name='new_location_code' value='{$_location_code}' placeholder='请输入代码'>";
$_body .= " </div>";
//<---
//--->
$_body .= " <div class='form-inline'>";
$_body .= " <label for='new_location_text' class='control-label mr-1'>名称</label>";
$_body .= " <input type='text' class='form-control' style='width:300px' id='new_location_text' name='new_location_text' value='{$_location_text}' placeholder='请输入名称'>";
$_body .= " </div>";
//<---
$_body .="</div>";
//<-
...
$_location_code = isset($_GET['edit_location_code']) ? $_GET['edit_location_code'] : "";
$_location_text = isset($_GET['edit_location_text']) ? $_GET['edit_location_text'] : "";
...
//--->
$_body .= " <div class='form-inline'>";
$_body .= " <label for='edit_location_code' class='control-label mr-1'>代码</label>";
$_body .= " <input type='text' class='form-control' disabled style='width:120px' id='edit_location_code' name='edit_location_code' value='{$_location_code}' placeholder='请输入代码'>";
$_body .= " </div>";
//<---
//--->
$_body .= " <div class='form-inline'>";
$_body .= " <label for='edit_location_text' class='control-label mr-1'>名称</label>";
$_body .= " <input type='text' class='form-control' style='width:300px' id='edit_location_text' name='edit_location_text' value='{$_location_text}' placeholder='请输入名称'>";
$_body .= " </div>";
//<---
$_body .="</div>";
//<-
...
function build_table(){
    ...
    $sql = "select * from tb_location {$page_limit};";
