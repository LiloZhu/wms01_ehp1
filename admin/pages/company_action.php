...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    switch($_POST['action']) {
        case 'retrieve':
            $sql = "select * from tb_company where id = '{$data['id']}' ";
        ...
        case 'add':
            ...
            $sql .= "values(null,'{$data['company_code']}','{$data['company_text']}','{$data['country_code']}','{$data['currency_code']}','{$data['language_code']}',";
            $sql .= "'{$data['address']}',";
            $sql .= "'{$data['tel_number']}',";
            $sql .= "'{$data['tel_extens']}',";
            $sql .= "'{$data['mobile']}',";
            ...
            if ($action_flag != FALSE){
                ...
                $arrResult['message']= $data['company_code'];
            }
            break;
        case 'edit':
            $sql ="";
            $sql .= "update tb_company set company_code = '{$data['company_code']}',company_text = '{$data['company_text']}',
                     address = '{$data['address']}',tel_number = '{$data['tel_number']}',
                     tel_extens = '{$data['tel_extens']}',mobile = '{$data['mobile']}',
                     fax = '{$data['fax']}',active = {$data['active']},delete_flag = {$data['delete_flag']},
