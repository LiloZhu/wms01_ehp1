...
<script src="../../js/common.js"></script>
  ...
  //->New
		$('#btn_new').click(function(){
		   $("select[name='cat_code']").removeAttr("disabled");
		});	
		
    	$('#btn_new_submit').click(function(){
        var _cat_code = $("select[name='new_cat_code']").val();
        var _type_code = $('#new_type_code').val();
        var _type_text = $('#new_type_text').val();
...
//     	//->edit
		$('#btn_edit').click(function(){
			...
			$("select[name='edit_cat_code']").val(getSelectedRowFieldValue('#tab_01','cat_code'));
			$('#edit_type_code').val(getSelectedRowFieldValue('#tab_01','类型代码'));
			$('#edit_type_text').val(getSelectedRowFieldValue('#tab_01','类型文本'));
			$('#edit_where_use').val(getSelectedRowFieldValue('#tab_01','where_use'));	
			$('#edit_seq').val(getSelectedRowFieldValue('#tab_01','序号'));	
			$('#btn_edit_submit').attr("disabled",($('#edit_id').val() == '' ? true : false ));	
			//alert(checkSelection('#tab_01'));

			//key update input disable
			/*
			$("select[name='cat_code']").attr('disabled',"true");
			$('#edit_type_code').attr('disabled',"true");
    	...
    	var _id = $('#edit_id').val();	
        var _cat_code = $("select[name='edit_cat_code']").val();
        var _type_code = $('#edit_type_code').val();
        var _type_text = $('#edit_type_text').val();
    ...
                success: function(data){
        ...
                   $.ajax({
        	...
        	               }
                		   ...
                		   window.location='type.php' + _condition;
        	            },
        				error:function(data){
...
$_type_code = isset($_GET['new_type_code']) ? $_GET['new_type_code'] : "";
$_type_text = isset($_GET['new_type_text']) ? $_GET['new_type_text'] : "";
...
//--->
$_body .= $GLOBALS['obj_cat']->build_html_category('new_cat_code','');
//<---
$_body .="</div>";
//<-
...
$_body .= " <label for='new_type_code' class='control-label mr-1'>代码</label>";
$_body .= " <input type='text' class='form-control' style='width:120px' id='new_type_code' name='new_type_code' value='{$_type_code}' placeholder='请输入代码'>";
$_body .= " </div>";
//<---
//--->
$_body .= " <div class='form-inline'>";
$_body .= " <label for='new_type_text' class='control-label mr-1'>名称</label>";
$_body .= " <input type='text' class='form-control' style='width:300px' id='new_type_text' name='new_type_text' value='{$_type_text}' placeholder='请输入名称'>";
$_body .= " </div>";
//<---
$_body .="</div>";
//<-
...
$_cat_code = isset($_GET['eidt_cat_code']) ? $_GET['eidt_cat_code'] : "";
$_type_code = isset($_GET['eidt_type_code']) ? $_GET['eidt_type_code'] : "";
$_type_text = isset($_GET['edit_type_text']) ? $_GET['edit_type_text'] : "";
...
$_body .="<div class='form-row mb-1'> ";
//--->
$_body .= $GLOBALS['obj_cat']->build_html_category('edit_cat_code','');
//<---
$_body .="</div>";
//<-
...
//--->
$_body .= " <div class='form-inline'>";
$_body .= " <label for='edit_type_code' class='control-label mr-1'>代码</label>";
$_body .= " <input type='text' class='form-control' style='width:120px' id='edit_type_code' name='edit_type_code' value='{$_type_code}' placeholder='请输入代码'>";
$_body .= " </div>";
//<---
//--->
$_body .= " <div class='form-inline'>";
$_body .= " <label for='edit_type_text' class='control-label mr-1'>名称</label>";
$_body .= " <input type='text' class='form-control' style='width:300px' id='edit_type_text' name='edit_type_text' value='{$_type_text}' placeholder='请输入名称'>";
$_body .= " </div>";
//<---
$_body .="</div>";
//<-
...
function build_table(){
    ...
    $sql = "";
    $sql = "select a.id, b.cat_code, b.cat_text,a.type_code,a.type_text,a.where_use,a.seq ";
    $sql .= "from tb_type a left join tb_category b on a.cat_code = b.cat_code  {$page_limit};";
