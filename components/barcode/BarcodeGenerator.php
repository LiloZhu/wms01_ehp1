...
use components\barcode\Exceptions\UnknownTypeException;
use components\barcode\Types\TypeCodabar;
use components\barcode\Types\TypeCode11;
use components\barcode\Types\TypeCode128;
use components\barcode\Types\TypeCode128A;
use components\barcode\Types\TypeCode128B;
use components\barcode\Types\TypeCode128C;
use components\barcode\Types\TypeCode39;
use components\barcode\Types\TypeCode39Checksum;
use components\barcode\Types\TypeCode39Extended;
use components\barcode\Types\TypeCode39ExtendedChecksum;
use components\barcode\Types\TypeCode93;
use components\barcode\Types\TypeEan13;
use components\barcode\Types\TypeEan8;
use components\barcode\Types\TypeIntelligentMailBarcode;
use components\barcode\Types\TypeInterleaved25;
use components\barcode\Types\TypeInterleaved25Checksum;
use components\barcode\Types\TypeKix;
use components\barcode\Types\TypeMsi;
use components\barcode\Types\TypeMsiChecksum;
use components\barcode\Types\TypePharmacode;
use components\barcode\Types\TypePharmacodeTwoCode;
use components\barcode\Types\TypePlanet;
use components\barcode\Types\TypePostnet;
use components\barcode\Types\TypeRms4cc;
use components\barcode\Types\TypeStandard2of5;
use components\barcode\Types\TypeStandard2of5Checksum;
use components\barcode\Types\TypeUpcA;
use components\barcode\Types\TypeUpcE;
use components\barcode\Types\TypeUpcExtension2;
use components\barcode\Types\TypeUpcExtension5;
