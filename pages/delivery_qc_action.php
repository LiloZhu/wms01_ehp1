...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    switch($_POST['action']) {
        case 'retrieve':
            ...
            $sql = "select * from v_delivery_order_text_ext where qc_indicator = true  order by id;";
        ...
        case 'reject':
            ...
            $sql = "update tb_delivery_order set status_code = '{$data['status_code']}',qc_approver = '{$uid}',change_at = sysdate(), change_by = '{$uid}' where id = '{$data['key']}'; ";
