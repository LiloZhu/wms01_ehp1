	...
	<table id="table" class="table-sm" data-toolbar="#toolbar"
		...
		<thead style="background: #efefef;">
			<tr>
				...
				<th data-field="put_in_number" >上架单号</th>
				<th data-field="rfid" data-width="220">RFID</th>
				<th data-field="mat_code" >物料编码</th>
				<th data-field="cust_mat_code" >客户物料编码</th>
